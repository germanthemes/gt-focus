...
function gt_focus_customize_preview_js() {
	wp_enqueue_script( 'gt-focus-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20191212', true );
	...
	if ( class_exists( 'GermanThemes_Local_Fonts' ) ) {
		...
		wp_localize_script( 'gt-focus-customize-preview', 'gtFocusFontSettings', $font_settings );
	}
}
...
function gt_focus_customizer_controls_js() {
	wp_enqueue_script( 'gt-focus-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.min.js', array(), '20200825', true );
}
...
function gt_focus_customizer_controls_css() {
	wp_enqueue_style( 'gt-focus-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20191130' );
}
