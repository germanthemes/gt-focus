...
function gt_focus_customize_preview_js() {
	wp_enqueue_script( 'gt-focus-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.js', array( 'customize-preview' ), '20191130', true );
}
...
function gt_focus_customizer_controls_js() {
	wp_enqueue_script( 'gt-focus-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.js', array(), '20191130', true );
}
