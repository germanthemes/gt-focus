...
function gt_focus_customize_preview_js() {
	wp_enqueue_script( 'gt-focus-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20210216', true );
}
...
function gt_focus_customizer_controls_js() {
	wp_enqueue_script( 'gt-focus-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.min.js', array(), '20210216', true );
}
...
function gt_focus_customizer_controls_css() {
	wp_enqueue_style( 'gt-focus-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20210216' );
}
