...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class GT_Focus_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'gt_focus_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gt-focus' ),
				'next'     => esc_html__( 'Next Font', 'gt-focus' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gt-focus' ),
			);

			// Set Fonts.
			$this->fonts = GT_Focus_Custom_Fonts::get_available_fonts();
