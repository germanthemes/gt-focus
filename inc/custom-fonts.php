...
class GT_Focus_Custom_Fonts {
	...
	static function remove_default_theme_fonts() {
		...
		// Remove default Lato font if not needed or GT Local Font plugin already loads it.
		if ( ( ! in_array( 'Lato', $selected_fonts ) && ! is_customize_preview() ) or class_exists( 'GermanThemes_Local_Fonts' ) ) {
			wp_dequeue_style( 'gt-focus-theme-fonts' );
		}
	}
	...
	static function get_available_fonts() {
		...
		$fonts = array(
			...
			'Lato'                        => 'Lato', // default font from /assets/css/theme-fonts.css
