...
( function( $ ) {
	...
	wp.customize( 'gt_focus_theme_options[post_title_color]', function( value ) {
		value.bind( function( newval ) {
			document.documentElement.style.setProperty( '--post-title-color', newval );
		} );
	} );
	...
	function loadCustomFont( font, type ) {
		if (typeof gtFocusFontSettings === 'undefined') {
			return;
		}
		...
		var fontFileURL = gtFocusFontSettings.pluginURL + fontFile + ".css";
